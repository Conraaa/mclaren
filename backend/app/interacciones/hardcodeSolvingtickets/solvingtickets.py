...
def getTickets(request):
    if request.method == "GET":
        ...
        tickets = [
            {"Asunto": "Problema de conexion","Estado": "P","Prioridad": "A","Categoria": "Mclaren","Usuario_DNI": "101", "Usuario_Nombre": "Estratega", "Mensaje": "Desde hoy temprano estoy experimentando problemas de conexion con el sistema. La conexion es inestable y no puedo acceder correctamente. He intentado varias soluciones sin exito. Agradeceria su ayuda para resolver este inconveniente lo antes posible.", "Respuesta": []},
