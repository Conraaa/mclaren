...
function Cartita({ nombre, imagen, kilometros, pais, ciudad, onShowDetails }) {
  return (
    <div className="class">
      <Card className="card">
        ...
        <Card.Body>
          ...
          <Card.Text>Kilómetros: {kilometros}</Card.Text>
          <Card.Text>País: {pais}</Card.Text>
...
function ListaDeCircuitos() {
  ...
  <p>
    <strong>País:</strong> {selectedCircuito.pais}
  </p>
  <p>
    <strong>Ciudad:</strong> {selectedCircuito.ciudad}
  </p>
  <img
